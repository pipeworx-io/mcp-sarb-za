 ...
 * `sarb_timeseries` to pull the historical observation series for that indicator.
 *
...
async function pwFetch(url: string | URL, init?: RequestInit): Promise<Response> {
  return fetchWithTimeout(url, init ?? {}, 'South African Reserve Bank');
}
...
const tools: McpToolExport['tools'] = [
  ...
  {
    name: 'sarb_current_market_rates',
    description:
      'Current South African money-market rates: SARB Policy Rate, Sabor, Zaronia. Each item includes a TimeseriesCode usable with the `sarb_timeseries` tool. No arguments.',
    inputSchema: { type: 'object', properties: {} },
  },
  {
    name: 'sarb_cpd_rates',
